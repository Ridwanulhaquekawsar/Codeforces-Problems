...
void solve(){
    ...
    // Binary Search or answer(max letter indices count to delete) ! 
    l = 0; // Worst-Case(max char delete) Scenerio ! 
    r = n; // Best-Case(max char delete) Scenerio !
    // (l & r) Represents the search inverval ! 
